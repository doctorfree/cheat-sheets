...
The coolest theme of them all is [Powerlevel10k](../powerlevel10k.md)
...
[Powerlevel10k](../powerlevel10k.md) is a backward-compatible reimplementation of the popular Powerlevel9k theme with 10-100 times better performance. When given the same configuration options it will generate the same prompt.
