...
The website `http://cheat.sh` provides unified access to community driven cheat sheets repositories. To access a cheat sheet you can simply issue a plain HTTP or HTTPS request
