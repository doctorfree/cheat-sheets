...
The `pokefetch` command was written by Ronald Record. It retrieves and displays a Pokemon using the [pokeapi](https://pokeapi.co/). Pokemon to be retrieved can be specified by name or id.
